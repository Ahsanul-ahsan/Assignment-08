...
const AllCourse = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto mt-8 mb-8">
            <div className="flex justify-between items-center text-center max-w-6xl px-6 mb-5">
                <div>
                ...
                <div>
                    <SearchField name="search">
                        <SearchField.Group>
                            ...
                            <SearchField.Input onChange={(e) => setSearch(e.target.value)} value={search} className=" w-30 md:w-70" placeholder="Search..." />
